-- ⚠️ NO EJECUTAR AUTOMÁTICAMENTE. Migración ORIGINAL (destructiva) 20260924120000, separada de
-- prisma/migrations porque contiene DROP TABLE / DROP COLUMN / DELETE sobre datos reales de
-- producción (wallet personal, wallet/QR del pago global, tablas de capital, columnas legacy de
-- statements, condición WALLET, pasos del proceso, guía). Requiere autorización explícita del
-- dueño del sistema y respaldo previo. La parte segura/aditiva quedó en
-- prisma/migrations/20260924120000_simplify_statements_bitget_transfer/migration.sql.
